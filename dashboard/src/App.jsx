                                  ...
                                  <div className="flex flex-col items-end gap-2.5 shrink-0 self-center sm:self-start">
                                    <div className="flex items-center gap-2">
                                      <button 
                                        ...
                                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl border text-[9px] font-extrabold uppercase tracking-wider transition-all duration-300 focus:outline-none focus:ring-0 bg-rose-500/15 border-rose-500/25 text-rose-400 hover:bg-rose-600 hover:text-white hover:border-rose-600"
                    ...
                    {accounts.filter(a => !a.is_active).length > 0 && (
                      <div className="flex flex-col gap-4 mt-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {accounts.filter(a => !a.is_active).map(acc => {
                            return (
                              <div key={acc.id} className="glass-card rounded-2xl p-6 flex flex-col justify-between border border-white/5 hover:border-cyan-500/10 transition-all duration-300 relative overflow-hidden opacity-75 hover:opacity-100">
                                <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${
                                  acc.env === 'production' 
                                  ? 'from-amber-400 to-amber-600' 
                                  : 'from-cyan-400 to-indigo-500'
                                ...
                                <div className="flex justify-between items-start">
                                  ...
                                  <div className="flex flex-col items-end gap-2.5 shrink-0 self-center sm:self-start">
                                    <div className="flex items-center gap-2">
                                      <button 
                                        onClick={() => handleToggleAccount(acc.id, acc.is_active)}
                                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl border text-[9px] font-extrabold uppercase tracking-wider transition-all duration-300 focus:outline-none focus:ring-0 bg-emerald-500/15 border-emerald-500/25 text-emerald-400 hover:bg-emerald-600 hover:text-white hover:border-emerald-600"
